...
const card4 = () => {
  ...
  return (
    <div className="py-20 flex flex-col items-center">
      ...
      <div className="bg-white shadow-xl mb-8 px-16 py-8 rounded-3xl w-4/5 md:w-3/5 lg:w-1/2 ">
      ...
      <div className="bg-white shadow-xl mb-8 px-16 py-8 rounded-3xl w-4/5 md:w-3/5 lg:w-1/2">
        ...
        <div>
          <p className="italic">"Action is the foundational key of success". Pablo Picasso</p>
          <p>
            Kodfec is an action and goal oriented software company which brings
            your thoughts to reality so that you can be action and goal
            oriented.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white shadow-xl mb-8 px-16 py-8 rounded-3xl w-4/5 md:w-3/5 lg:w-1/2">
        ...
        <div>
          <p className="italic">
            "Flexibility makes building stronger. Imagine what it can do to your
            soul" Carlos Barrios
          </p>
